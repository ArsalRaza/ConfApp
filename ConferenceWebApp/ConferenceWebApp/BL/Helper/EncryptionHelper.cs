...
namespace ConferenceWebApp.BL.Helper
{
    public class EncryptionHelper
    {
        ...
        private static string strThekey = "us^d31@H478HGY@562";
        ...
        public static String EncryptPass(String strToEncrypt)
        {
            ...
            hashedBytes = md5Hasher.ComputeHash(encoder.GetBytes(strToEncrypt));
            string result = "";
        ...
        {
            byte[] hash;
            using (SHA512 sha5hasher = new SHA512Managed())
            {
                
                hash = sha5hasher.ComputeHash(Encoding.UTF8.GetBytes(text));
            }
